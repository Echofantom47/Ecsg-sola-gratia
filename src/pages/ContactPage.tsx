...
const ContactPage = () => (
  <PageLayout>
    <PageHero eyebrow="Contact" title="Une équipe disponible pour vous orienter." intro="Contactez directement l’administration pour les admissions, les frais, les horaires et les informations pédagogiques." image={authenticImages.campusEntrance} />
