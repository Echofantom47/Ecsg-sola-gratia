...
const ProgrammesPage = () => (
  <PageLayout>
    <PageHero eyebrow="Programmes" title="Quatre cycles. Un même engagement éducatif." intro="Un parcours continu de la maternelle au Baccalauréat, avec les séries A4, C et D au lycée." image={authenticImages.classroom} />
