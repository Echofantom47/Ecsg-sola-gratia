...
const AProposPage = () => (
  <PageLayout>
    <PageHero eyebrow="L’École" title="Une école de convictions, tournée vers l’avenir." intro="Sola Gratia associe formation scolaire, développement du caractère et valeurs chrétiennes depuis 2002." image={authenticImages.campusCourtyard} />
